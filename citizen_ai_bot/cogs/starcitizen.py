...
class StarCitizenCog(commands.Cog):
    ...
    async def helpme(self, interaction: discord.Interaction) -> None:
        ...
        await interaction.followup.send(embed=simple_embed("Citizen AI Help", text))
    ...
    async def status(self, interaction: discord.Interaction) -> None:
        ...
        await interaction.followup.send(embed=status_embed(status))
    ...
    async def item(
        ...
        await interaction.followup.send(
            embed=item_embed(name, rows, location=location, resolved_location=resolved_location)
        )
    ...
    async def route(self, interaction: discord.Interaction, commodity: str) -> None:
        ...
        await interaction.followup.send(embed=simple_embed(f"Route • {commodity}", text))
    ...
    async def multiroute(self, interaction: discord.Interaction, commodity: str) -> None:
        ...
        await interaction.followup.send(embed=simple_embed(f"Multi-route • {commodity}", text))
    ...
    async def mining(self, interaction: discord.Interaction, ship_name: str | None = None) -> None:
        ...
        await interaction.followup.send(embed=simple_embed("Mining", text))
    ...
    async def missions(
        ...
        await interaction.followup.send(embed=simple_embed("Missions", text))
    ...
    async def risk(
        ...
        await interaction.followup.send(embed=simple_embed("Risk", text))
    ...
    async def trend(self, interaction: discord.Interaction, commodity: str) -> None:
        ...
        await interaction.followup.send(embed=simple_embed(f"Trend • {commodity}", text))
    ...
    async def op(
        ...
        await interaction.followup.send(embed=simple_embed("Operation", text))
